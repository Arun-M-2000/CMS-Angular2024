...
public medicineQuantity: number = 0;
  ...
  constructor(private toastr : ToastrService, private router : Router, public diagnosisService : DDiagnosisViewModelService, private cdr: ChangeDetectorRef,private route:ActivatedRoute) { }
  ...
  ngOnInit(): void {
    ...
    this.diagnosisService.formData=new DDiagnosisViewModel();  // to reset the form if it's autoifilled
